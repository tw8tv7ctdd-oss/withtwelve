...
function SafetyPage() {
  return (
    <AppShell>
      <ScreenHeading title="Safety & safeguarding" />
      <div className="space-y-5 text-sm leading-relaxed text-foreground">
        <p>
          WithTwelve is designed to be spiritually warm, emotionally safe, and rooted in
          scripture. It is not a replacement for emergency support, medical care, therapy, or
          crisis intervention.
        </p>
        <p>
        ...
        <p>
          If you or someone else may be in immediate danger, please contact local emergency
          services or a trusted person near you now.
        </p>
        <p>
        ...
        <p className="text-muted-foreground">
          WithTwelve can support reflection, prayerful thought, and scripture-based encouragement,
          but it cannot safely handle emergency or crisis care.
        </p>
      </div>
    </AppShell>
  );
